...
enum APIError : Error {
    ...
    var errorDescription: String? {
        ...
        case .decodingError(let decodingError):
            print("Decoding Error: \(decodingError)") // Log for developers
        ...
        case .serverError(let statusCode, _):
            if statusCode == 401 {
                return NSLocalizedString("You are not authorized. Please log in again.", comment: "Unauthorized error message")
        ...
        case .unauthorized:
            return NSLocalizedString("You are not authorized to perform this action. Please log in again.", comment: "Unauthorized specific error")
        case .unknown:
